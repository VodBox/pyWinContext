...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Saving will export to the registry directly. Any crashes or bugs may result in changes not being completed. The quickest option. (Requires Admin)"))
